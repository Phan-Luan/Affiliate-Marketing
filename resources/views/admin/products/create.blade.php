        ...
        <div class="col-md-12">
            <div class="portlet light portlet-datatable bordered">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card p-3">
                        <form action="{{ route('ad.product.store') }}" method="POST" @submit.prevent="onSubmit"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                        ...
                                        <input type="text" id="name" required class="form-control" name="name"
                                            v-validate="'required'" data-vv-as="&quot;Tiêu đề&quot;"
                                            value="{{ old('name') }}">
                                    </div>
                                    <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                    ...
                                    <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                        ...
                                        <input type="number" required id="origin" class="form-control" name="origin"
                                            value="{{ old('origin') }}">
                                    </div>
                                    <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                        <label for="origin">Điểm Smile<span class="required">*</span></label>
                                        <input type="number" required id="point_buy" class="form-control" name="point_buy"
                                            value="{{ old('point_buy') }}">
                                    </div>
                                        ...
                                        <div>
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 200px;">
                                                    <img class="img-responsive" src="{{ asset('images/no_image.png') }}"
                                                        alt="" />
                                                </div>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="{{ route('ad.product.index') }}" class="btn btn-default">Quay lại</a>
                            </div>
                        </form>
                    </div>
                </div>
