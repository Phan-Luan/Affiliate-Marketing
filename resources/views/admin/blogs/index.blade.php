        ...
        <div class="col-md-12">
            <div class="portlet light portlet-datatable bordered">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card p-3">
                        <form action="{{route('ad.blog.index')}}" method="GET" class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2 pt-4">
                                <div>
                                    ...
                                    <a class="btn btn-info btn-sm text-white" href="{{route('ad.blog.index')}}" style="height: 32px">Clear</a>
                                </div>
                            </div>
                        </form>
                        <hr>
                        <table class="table table-bordered table-hover" id="admin-table">
                            ...
                            @foreach ($blogs as $key=>$blog)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ $blog->name }}</td>
                                    <td><img src="{{ $blog->image }}" style="max-width: 200px" alt=""></td>
                                    <td>{{ $blog->description }}</td>
                                    <td>{{ $blog->category->name }}</td>
                                    <td>
                                        <a class="btn btn-circle btn-sm btn-warning" href="{{ route('ad.blog.edit', $blog) }}"><i class='bx bx-edit' ></i></a>
