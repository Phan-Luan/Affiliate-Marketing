                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group" :class="[errors.has('key') ? 'has-error' : '']">
                                    ...
                                    <input type="text" id="key" class="form-control" name="key" v-validate="'required'" data-vv-as="&quot;Key&quot;" value="{{ old('key', $config->key) }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group" :class="[errors.has('value') ? 'has-error' : '']">
                                    ...
                                    <textarea  class="form-control" name="value" id="value" cols="30" rows="10" v-validate="'required'" data-vv-as="&quot;Value&quot;" >{{ old('value', $config->value) }}</textarea>
