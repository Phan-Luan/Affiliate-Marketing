...
@section('page_title', 'Tạo mới banner')
        ...
        <div class="col-md-12">
            <div class="portlet light portlet-datatable bordered">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card p-3">
                        <form action="{{ route('ad.banner.store') }}" method="POST" @submit.prevent="onSubmit" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                        ...
                                        <input type="number" min="1" id="position" required class="form-control" name="position" value="{{ old('position') }}">
                                    </div>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="{{ route('ad.banner.index') }}" class="btn btn-default">Quay lại</a>
                            </div>
                        </form>
                    </div>
                </div>
