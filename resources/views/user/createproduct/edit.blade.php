                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-datatable bordered">
                                            ...
                                            <div class="container-xxl flex-grow-1 container-p-y">
                                                <div class="card p-3">
                                                    <form action="{{ route('ad.product.update', $product) }}" method="POST"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="form-group"
                                                                    :class="[errors.has('name') ? 'has-error' : '']">
                                                                    <label for="price_sale">Giá nhập<span
                                                                            class="required">*</span></label>
                                                                    <input type="number" required id="price_sale"
                                                                        class="form-control" name="price_sale"
                                                                ...
                                                                <div class="form-group"
                                                                    ...
                                                                    <label for="origin">Giá niêm yết<span
                                                                            class="required">*</span></label>
                                                                    <input type="number" required id="origin"
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="image">Hình ảnh <span
                                                                            class="required">*</span></label>
                                                                    <div>
                                                                        <div class="fileinput fileinput-{{ $product->image ? 'exists' : 'new' }}"
                                                                            ...
                                                                            <div>
                                                                                <span
                                                                                    class="btn default btn-file btn-danger">
                                                                                    <span class="fileinput-new">Chọn
                                                                                        ảnh</span>
                                                                                    <span class="fileinput-exists">Đổi
                                                                                        ảnh</span>
                                                                ...
                                                                <div class="form-group"
                                                                    ...
                                                                    <textarea type="text" id="description" class="form-control" name="description" v-validate="'required'"
                                                                        data-vv-as="&quot;Mô tả&quot;">{{ old('description', $product->description) }}</textarea>
